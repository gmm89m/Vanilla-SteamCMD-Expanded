...
window.RIMMOD_LOCALE = {
    ...
    settings_quickstart:  "<b>Что означают эти настройки</b><br>" +
                          ...
                          "<b>ZIP-бэкап перед детекцией</b> – при активации этой опции и последующем нажатии «Найти установленные моды» (на странице «Моды») будет создана резервная копия всей папки Mods.<br>" +
    ...
    guide_tips:           "<b>Профили</b> – управляйте несколькими играми через выпадающий список в сайдбаре. Создавайте/редактируйте кнопками <b>+</b> и <b>⚙</b>.<br>" +
                          ...
                          "<b>Категории</b> – клик для сворачивания/разворачивания, кнопки Всё/Снять выделяют моды внутри секции.<br>" +
